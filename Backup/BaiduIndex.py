...
def openbrowser():
    ...
    #     exit()
    browser.find_element_by_id("TANGRAM__PSP_3__userName").send_keys("13573851892")
    browser.find_element_by_id("TANGRAM__PSP_3__password").send_keys("18353258669x")
...
def getindex(keyword, day):
    ...
    file = open(r"E:\PyCharmProjects\MasonicDeepLearning\baidu\index.txt", "w")
    for item in index:
        file.write(str(item) + "\n")
    file.close()
