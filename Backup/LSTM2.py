...
xtrain, xtest, ytrain, ytest = getdivideddataset(readxls(DIRECTORY, SHEET), 1)
data = xtrain
    ...
    with tf.Session() as sess:
        ...
        for step in range(100000):
            ...
            if step % 10 == 0:
                # 用测试数据评估loss
                print(step, loss_)
        print("保存模型: ", saver.save(sess, r'E:\PyCharmProjects\MasonicDeepLearning\Modelsass.model'))
